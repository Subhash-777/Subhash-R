...
% Adapted for Subhash R — Full Stack Developer
%-------------------------
...
% ── ONE-LINE TITLE ──────────────────────────────────────────────────
\begin{center}
  \small\textit{Full Stack Developer \ $\cdot$ \ Backend Systems \ $\cdot$ \ AI Integration \ $\cdot$ \ Published IEEE Researcher}
\end{center}
\vspace{-10pt}
...
\resumeSubHeadingListStart
  \resumeSubheading
    ...
    {B.Tech in Computer Science and Engineering (AI) \quad GPA: 7.52\,/\,10}{Aug. 2023 -- May 2027}
  \resumeItemListStart
...
\resumeSubHeadingListStart
  ...
  \resumeProjectHeading
    {\textbf{Focus Flow AI: Productivity Intelligence Platform} \\
     \small\textit{Next.js, TypeScript, FastAPI, Ollama (LLaMA 3), Firebase, Docker, OAuth 2.0}
     \href{https://github.com/Subhash-777}{\, \small[\faGithub]}}{Dec 2025 -- Jan 2026}
  \resumeItemListStart
    \resumeItem{Architected a full-stack AI productivity platform integrating Google Calendar and Gmail APIs via OAuth 2.0; built a FastAPI backend delivering LLM-driven cognitive load inference via Ollama (LLaMA 3) at sub-300ms API response latency.}
    \resumeItem{Engineered a Dockerized multi-service stack (Next.js frontend, FastAPI server, LLM inference); implemented Firebase real-time sync for session and concurrent multi-user workflow management across the platform.}
  \resumeItemListEnd

  \resumeProjectHeading
    {\textbf{Smart-City Real-Time Traffic Intelligence System} \\
     \small\textit{Apache Kafka, Spark Streaming, Hadoop, HDFS, MongoDB, Python, scikit-learn}
     \href{https://github.com/Subhash-777}{\, \small[\faGithub]}}{2025}
  \resumeItemListStart
    \resumeItem{Architected a distributed streaming pipeline ingesting 10,000+ IoT events/sec via Apache Kafka with Spark Streaming jobs for real-time congestion classification, reducing event-to-alert latency by 40\% over batch baselines across a 5-tier severity model.}
    \resumeItem{Designed an HDFS-backed data lake with MongoDB operational storage; trained ML classifiers achieving 89\% congestion prediction accuracy; exposed insights via a REST API layer serving live monitoring dashboards.}
  \resumeItemListEnd

  \resumeProjectHeading
    {\textbf{E-Commerce Legal Metrology Compliance Platform} \\
     \small\textit{React (Vite), TypeScript, Node.js, Express.js, MySQL, Docker, Tesseract OCR}
     \href{https://github.com/Subhash-777}{\, \small[\faGithub]}}{Aug -- Sep 2024}
  \resumeItemListStart
    \resumeItem{Developed a production-grade full-stack compliance system with a React/TypeScript SPA and Node.js/Express REST API; integrated Tesseract OCR achieving 94\% field-accuracy, validating 500+ product listings against 15+ legal metrology regulations.}
    \vspace{-4mm}
    \resumeItem{Implemented RBAC, PDF report export, and a normalized MySQL schema; containerized the full stack with Docker, enabling reproducible deployment and streamlined development-to-staging CI workflows.}
  \resumeItemListEnd
